...
# '0 problematic directories' should be impossible
test_expect_success "Pluralizes directories properly" "
  test_expect_code 1 gird --verify a 2> stderr
  echo 'a: does not exist' > expected &&
  echo 'gird found 1 problematic directory' >> expected &&
  test_cmp expected stderr &&
  test_expect_code 1 gird --verify a b 2> stderr
  echo 'a: does not exist' > expected &&
  echo 'b: does not exist' >> expected &&
  echo 'gird found 2 problematic directories' >> expected &&
  test_cmp expected stderr &&
  rm expected stderr
"
